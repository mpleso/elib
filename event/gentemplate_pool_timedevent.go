...
// generated from gentemplate [gentemplate -d Package=event -id timedEvent -d PoolType=timedEventPool -d Type=TimedActor -d Data=events github.com/platinasystems/elib/pool.tmpl]
