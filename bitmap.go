...
func (p *BitmapPool) Foreach(b Bitmap, fn func(int) error) (err error) {
	var s []Bitmap
	if !b.isPoolIndex() {
		s = []Bitmap{b}
	} else {
...
func (b Bitmap) Foreach(fn func(int) error) (err error) {
	return Bitmaps.Foreach(b, fn)
}
